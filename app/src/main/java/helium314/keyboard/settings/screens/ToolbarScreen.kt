...
fun ToolbarScreen(
    ...
    val items = listOf(
        ...
        if (toolbarMode != ToolbarMode.HIDDEN) Settings.PREF_TOOLBAR_CUSTOM_KEY_CODES else null,
        if (toolbarMode != ToolbarMode.HIDDEN) SettingsWithoutKey.CUSTOM_AI_KEYS else null,
